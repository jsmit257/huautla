...
values('0', 'reference implementation', 8, 1, 2, 3, 4, 5, '1', '4', 'no-op3'),
      ...
      ('add lc event', 'add lc event', 6, 0, 0, 0, 0, 0, '0', '0', '2'),
      ('lc insert event', 'lc insert event', 6, 0, 0, 0, 0, 0, '0', '0', '2'),
      ('lc change event', 'lc change event', 5, 0, 0, 0, 0, 0, '0', '0', '0'),
      ('remove event', 'remove event', 4, 0, 0, 0, 0, 0, '0', '0', '0'),
      ('lc delete event', 'lc delete event', 4, 0, 0, 0, 0, 0, '0', '0', '0'),
...
values('0', '2', '3'),
      ...
      ('add event source gen', '2', '3'),
      ('add source', '2', '3'),
      ('fail source check', '2', '3'),
      ('change source', '2', '3'),
      ('remove source', '2', '3'),
      ('add gen event', '2', '3'),
      ('gen insert event', '2', '3'),
      ('has events', '2', '3'),
      ('gen change event', '2', '3'),
      ('get gen event', '2', '3'),
      ('insert notable', '2', '3'),
      ('update notable', '2', '3'),
      ('remove gen event', '2', '3'),
      ('gen delete event', '2', '3'),
      ('photo', '2', '3'),
      ('add photo', '2', '3'),
      ('update me!', '2', '3'),
      ('delete me!', '2', '3'),
...
values('0', 2, 1, '0', '1'),
      ...
      ('clone', 10, 11, '0', 'clone'),
      ('add event', 0, 1, 'add lc event', '0'),
      ('lc change event', 0, 8, 'lc change event', '0'),
      ('gen change event', 0, 8, 'gen change event', '0'),
      ('remove event 1', 0, 8, 'remove event', '0'),
      ('remove event 2', 0, 8, 'remove event', '0'),
      ('remove event 3', 0, 8, 'remove event', '0'),
      ('lc delete event', 0, 8, 'lc delete event', '0'),
      ('gen delete event', 0, 8, 'gen delete event', '0'),
